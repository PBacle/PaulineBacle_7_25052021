      ...
      if(result.length > 0){
        ...
        if (req.file || req.body.deleteImage) {
          if(user.avatarUrl){
            ...
            newAvatar = req.file ? `${req.protocol}://${req.get("host")}/upload/${req.file.filename}`:  null;
        }

        newPseudo = (req.file || req.body.deleteImage) ? user.pseudo : req.body.pseudo ;
        ...
        newBio = (req.file || req.body.deleteImage) ? user.bio : req.body.bio ;
